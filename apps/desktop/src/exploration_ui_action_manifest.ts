...
export const EXPLORATION_UI_ACTION_MANIFEST: readonly ExplorationUiActionManifestEntry[] = Object.freeze([
  ...
  connected("workspace-search-input", "shell", "view_state", "WorkspaceSearch.query", "workspace search field"),
  connected("submit-workspace-search", "shell", "route", "DesktopRoute.Search", "onSearch"),
  ...
  connected("open-graph-asset", "graph", "route", "DesktopRoute.Assets", "onOpenAsset"),
  connected("graph-scope-local", "graph", "route", "DesktopRoute.Graph.Local", "onGraphScopeChange"),
  connected("graph-scope-global", "graph", "route", "DesktopRoute.Graph.Global", "onGraphScopeChange"),
  ...
  connected("graph-toggle-external", "graph", "presentation", "graph_visual_filter", "onGraphIncludeExternalChange"),
  ...
  connected("graph-reset-layout", "graph", "view_state", "TopologyLayout.reset", "resetLayout"),
  connected("graph-pause-layout", "graph", "view_state", "TopologyLayout.pause", "pauseLayout"),
  connected("graph-resume-layout", "graph", "view_state", "TopologyLayout.resume", "resumeLayout"),
  ...
  connected("select-canvas-catalog", "canvas", "native_command", "select_desktop_canvas", "onCanvasSelect"),
  connected("retry-canvas-catalog", "canvas", "native_command", "get_desktop_canvas_catalog", "onCanvasCatalogRetry"),
  ...
  connected("edit-canvas-text-card", "canvas", "view_state", "CanvasTextEditDialog", "onCanvasTextEditRequest"),
  connected("edit-canvas-text", "canvas", "view_state", "CanvasTextEditDialog.draft", "onCanvasTextEditDraftChange"),
  connected("cancel-canvas-text-edit", "canvas", "view_state", "CanvasTextEditDialog", "onCanvasTextEditCancel"),
  connected("confirm-canvas-text-edit", "canvas", "native_command", "execute_desktop_canvas", "onCanvasTextEdit"),
  ...
  connected("restart-asset-import", "assets", "native_command", "import_desktop_asset", "onAssetImport"),
  connected("repair-asset-import", "assets", "native_command", "repair_desktop_projection", "onAssetRepair"),
  ...
  connected("load-more-assets", "assets", "native_command", "list_desktop_workspace_assets", "onAssetLoadMore"),
  connected("filter-assets-all", "assets", "view_state", "AssetSurface.mediaFilter", "onAssetMediaFilterChange"),
  connected("filter-assets-image", "assets", "view_state", "AssetSurface.mediaFilter", "onAssetMediaFilterChange"),
  connected("filter-assets-pdf", "assets", "view_state", "AssetSurface.mediaFilter", "onAssetMediaFilterChange"),
  connected("filter-assets-document", "assets", "view_state", "AssetSurface.mediaFilter", "onAssetMediaFilterChange"),
  connected("filter-assets-other", "assets", "view_state", "AssetSurface.mediaFilter", "onAssetMediaFilterChange"),
  connected("search-assets", "assets", "view_state", "AssetSurface.query", "onAssetQueryChange"),
]);
