...
export interface DesktopGlobalGraphQuery { readonly workspaceId: string; readonly cursor?: string; readonly projectionLimit: number; readonly nodeLimit: number; readonly edgeLimit: number }
export interface DesktopGlobalGraphView { readonly status: "clean" | "degraded"; readonly nodes: readonly { readonly id: string; readonly kind: "document" | "unresolved_link" | "attachment" | "external_link" }[]; readonly edges: readonly { readonly id: string; readonly sourceId: string; readonly targetId: string; readonly kind: "document_link" | "attachment_reference" | "external_reference" | "canvas_relation" }[]; readonly candidateCount: number; readonly nextCursor?: string }
